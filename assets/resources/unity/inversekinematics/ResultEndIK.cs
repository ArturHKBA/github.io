...
namespace ResultEndIK
{
    public class ResultEndIK
    {
        public ResultEndIK(Vector3 _ikPos, Vector3 _gluedIkPos, bool _isGlued, Vector3 _bottomPoint, Vector3 _surfacePoint, Vector3 _normal, Transform _primaryHitTransform, Transform _secondaryHitTransform)
        {
    ...
    [System.Serializable]
    public class ResultEndIKEvent : UnityEngine.Events.UnityEvent<ResultEndIK>
    {
    }
}