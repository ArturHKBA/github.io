	...
	AddTextComponentString("feuer #" .. dispatchNumber)
...
function Dispatch:playTone()
	...
	for k, v in ipairs(Config.Dispatch.toneSources) do
		...
		Citizen.CreateThread(
			function()
				PlaySoundFromCoord(soundID, "long_beeps", v.x, v.y, v.z, "feuerscript_alarm", 0, 150, 0)

				Citizen.Wait(8000)

				PlaySoundFromCoord(soundID, "short_beeps", v.x, v.y, v.z, "feuerscript_alarm", 0, 150, 0)
