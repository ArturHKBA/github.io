...
namespace ResultOnGround
{

    public class ResultOnGround
    {
        public ResultOnGround(bool _isValid, bool _isGrounded, Transform _groundedTransform, Vector3 _groundedPoint, Vector3 _groundedPosition, Vector3 _groundedNormal)
        {
    ...
    [System.Serializable]
    public class ResultOnGroundEvent : UnityEngine.Events.UnityEvent<ResultOnGround>
    {
    }
}